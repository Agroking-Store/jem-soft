        ...
        <CustomerSectionCard title="Loan Information" icon={FileText}>
          ...
          <div className="w-[50%]">
            ...
            <select
              ...
              className={`mt-1.5 w-full px-3 py-2.75 text-sm border rounded-xl outline-none transition-all ${
                errors.policyId
                  ? "border-rose-300 focus:border-rose-400 focus:ring-2 focus:ring-rose-400/15"
                  : "border-slate-200 hover:border-slate-300 focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15"
              } ${mode === "edit" ? "bg-slate-50 cursor-not-allowed" : "bg-white"}`}
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
              ...
              <div className="sm:col-span-2">
                ...
                <textarea
                  ...
                  className="mt-1.5 w-full rounded-xl border border-slate-200 bg-white px-3 py-2.75 text-sm outline-none resize-none transition-all placeholder:text-slate-400 hover:border-slate-300 focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15"
                />
              </div>
            </div>
          )}
        ...
        {eligible && !hasActiveLoan && (
          <div className="pt-4 flex justify-end gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#5c67ff] to-[#3a47ff] px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-blue-200 transition-all hover:brightness-110 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer"
            >
              {isSubmitting ? (
