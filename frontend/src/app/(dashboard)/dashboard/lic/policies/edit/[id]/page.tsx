...
export default function EditLICPolicyPage() {
  ...
  const {
    ...
    resolver: zodResolver(policySchema) as Resolver<PolicyFormValues>,
    defaultValues: {
      riders: [],
    },
  });
    ...
    reset({
      ...
      riders:
        selectedPolicy.policyRiders?.map((r: any) => ({
          ...
          sum: typeof r.riderAmount === "number" ? r.riderAmount : undefined,
          premium:
            typeof r.riderPremium === "number" ? r.riderPremium : undefined,
          term: undefined,
          ppt: undefined,
        })) ?? [],
    });
