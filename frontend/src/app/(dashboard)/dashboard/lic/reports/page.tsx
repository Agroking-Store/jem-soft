      ...
      {currentView === "cards" && (
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-2xl border border-blue-100 bg-[#f0f7ff] p-5 shadow-sm">
            ...
            <div className="flex items-center gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm text-xs">
              <div className="text-center px-2">
                <span className="block text-2xl font-bold text-slate-900">18</span>
                <span className="text-slate-500 font-serif text-[10px] uppercase tracking-wider">Reports</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="relative w-full sm:w-80">
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50/50 py-2.5 pl-9 pr-4 text-xs focus:border-[#1877F2] focus:bg-white focus:ring-2 focus:ring-blue-500/15 outline-none transition-all"
              />
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto w-full sm:w-auto scrollbar-none">
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition uppercase tracking-wider cursor-pointer ${activeCategory === cat
                ...
                >
                  ...
                  <div className="space-y-3 pt-1">
                    <div className="flex items-center justify-between">
                      ...
                      {card.isFeatured && (
                        <span className="px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-600 font-bold text-[10px] uppercase tracking-wider border border-blue-200">
                          Featured Report
                        </span>
                      )}
                  ...
                  <div className="pt-4 mt-4 border-t border-slate-100 flex items-center justify-between text-xs font-bold text-slate-900 group-hover:text-[#1877F2] uppercase tracking-wider">
                    <span>
