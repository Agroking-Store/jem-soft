                ...
                {(["Type 1", "Type 2"] as const).map((type) => (
                  <button
                    ...
                    className={`flex-1 py-1.5 text-xs font-bold rounded-lg transition ${
                      formData.certificateType === type ? "bg-[#1877F2] text-white shadow-sm" : "text-slate-600 hover:text-slate-900"
                    }`}
                  >
                    {type}
                  </button>
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  <span className="absolute -top-2 left-3 bg-white px-1 text-[10px] text-[#1877F2] font-bold uppercase tracking-wider">From Date *</span>
                  <input
                    type="date"
                ...
                <div className="relative flex-1">
                  <span className="absolute -top-2 left-3 bg-white px-1 text-[10px] text-[#1877F2] font-bold uppercase tracking-wider">To Date *</span>
                  <input
                    type="date"
