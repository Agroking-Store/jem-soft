    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="flex items-center gap-8">
              {(["Standard", "Compact"] as const).map((opt) => (
                <label key={opt} className="flex items-center gap-2.5 text-xs font-bold text-slate-800 hover:text-[#1877F2] cursor-pointer transition">
                  <input
                    type="radio"
                    name="reportType"
          ...
          <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r from-[#1877F2] via-[#1877F2]/40 to-transparent" />
            <h2 className="text-sm font-bold uppercase tracking-wider text-slate-900 mb-4">Optional Columns</h2>
            <div className="flex items-center gap-8">
              {[
