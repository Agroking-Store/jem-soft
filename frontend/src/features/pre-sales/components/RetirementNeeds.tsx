  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6 pb-8">
      <div className="flex items-center justify-between gap-4">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900">Retirement Needs Analysis</h1>
      ...
      <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_8px_24px_rgba(15,23,42,0.05)]">
        ...
        <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50/70 px-5 py-4">
          <h2 className="text-xs font-bold uppercase tracking-[0.16em] text-slate-700">Proposer Info</h2>
        </div>
      ...
      <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_8px_24px_rgba(15,23,42,0.05)]">
        ...
        <div className="flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-1 break-words text-2xl font-bold text-slate-900">₹ {fmt(totalAnnualCost)}</p>
          </div>
          <div className="flex items-center gap-2">
            <button
