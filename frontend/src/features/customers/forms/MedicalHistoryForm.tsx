        ...
        <SectionCard title="Member's Details" icon={<Droplet size={16} />}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div>
              ...
              <input type="text" placeholder="e.g. 120/80" value={bloodPressure} onChange={(e) => setBloodPressure(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all" />
            </div>
            <div>
              <FieldLabel label="Pulse (bpm)" />
              <input type="text" placeholder="e.g. 72" value={pulse} onChange={(e) => setPulse(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all" />
            </div>
            <div>
              <FieldLabel label="Height (Cms)" />
              <input type="number" placeholder="e.g. 172" value={height} onChange={(e) => setHeight(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all" />
            </div>
            <div>
              <FieldLabel label="Weight (Kgs)" />
              <input type="number" placeholder="e.g. 68" value={weight} onChange={(e) => setWeight(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all" />
            </div>
            <div>
              <FieldLabel label="Chest (Cms)" />
              <input type="number" placeholder="e.g. 90" value={chest} onChange={(e) => setChest(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all" />
            </div>
            <div>
              <FieldLabel label="Abdomen (Cms)" />
              <input type="number" placeholder="e.g. 85" value={abdomen} onChange={(e) => setAbdomen(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all" />
            </div>
            <div>
              <FieldLabel label="Identification Mark" />
              <input type="text" placeholder="e.g. Mole on left forearm" value={identificationMark} onChange={(e) => setIdentificationMark(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all" />
            </div>
            <div>
              <FieldLabel label="Spectacles Details" />
              <input type="text" placeholder="e.g. -2.5 power" value={spectaclesDetails} onChange={(e) => setSpectaclesDetails(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all" />
            </div>
            <div className="md:col-span-3">
              <FieldLabel label="Dental Details" />
              <input type="text" placeholder="e.g. Upper molar crown" value={dentalDetails} onChange={(e) => setDentalDetails(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all" />
            </div>
          </div>
        </SectionCard>
        ...
        <SectionCard title="Examination Details" icon={<Stethoscope size={16} />}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="md:col-span-2">
              ...
              <textarea rows={2} placeholder="Any major illness history..." value={majorIllness} onChange={(e) => setMajorIllness(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all resize-none" />
            </div>
            <div className="md:col-span-2">
              <FieldLabel label="Operation / Accident" />
              <textarea rows={2} placeholder="Any operation or accident history..." value={operationAccident} onChange={(e) => setOperationAccident(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all resize-none" />
            </div>
            <div className="md:col-span-2">
              <FieldLabel label="Special Report" />
              <textarea rows={2} placeholder="Any special report..." value={specialReport} onChange={(e) => setSpecialReport(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all resize-none" />
            </div>
            <div>
              <FieldLabel label="Doctor Name" />
              <input type="text" placeholder="e.g. Dr. Sharma" value={doctorName} onChange={(e) => setDoctorName(e.target.value)} className="w-full border border-slate-200 rounded-lg py-2.5 px-3 text-sm text-slate-950 bg-white outline-none focus:border-[#1877F2] focus:ring-2 focus:ring-blue-500/15 transition-all" />
            </div>
            <div>
