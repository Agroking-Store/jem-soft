...
export const getInsuranceProviderById = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
...
export const createInsuranceProvider = catchAsync(async (req: Request, res: Response) => {
...
// @access  Private/Admin
export const updateInsuranceProvider = catchAsync(async (req: Request, res: Response) => {
...
// @access  Private/Admin
export const deleteInsuranceProvider = catchAsync(async (req: Request, res: Response) => {
