...
export async function seedLIC715SumAssuredRebates(prisma: PrismaClient) {
  ...
  if (!product) {
    throw new Error("LIC Plan 715 not found.");
  }
  ...
  console.log("✅ LIC Plan 715 Sum Assured Rebates Seeded");
}