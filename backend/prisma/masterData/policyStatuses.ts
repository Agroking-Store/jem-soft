export const policyStatuses = [
  ...
  },
  {
    statusName: "In-force",
    statusCode: "IN-FORCE",
    description: "The policy is in force and valid.",
  },
  {
    statusName: "Reduced Paid-Up",
    statusCode: "REDUCED PAID-UP",
    description: "The policy has been converted to a reduced paid-up status.",
  },
  {
  ...
  },
  {
    statusName: "Claimed",
    statusCode: "CLAIMED",
    description: "The policy has been claimed.",
  },
];
