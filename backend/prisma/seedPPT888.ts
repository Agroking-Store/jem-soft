...
export const seedPPT888 = async (prisma: PrismaClient) => {
    ...
    try {
        ...
        for (const policyTerm of allowedTerms) {
        ...
        console.log("\n=================================");
        console.log("PLAN 888 PPT SEEDING COMPLETE");
        console.log("=================================");

        console.log(`Plan Number : ${product.planNumber}`);
        console.log(`Product     : ${product.productName}`);
        console.log(`Terms       : 10, 15, 20, 25`);
        console.log(`PPT         : 1`);
